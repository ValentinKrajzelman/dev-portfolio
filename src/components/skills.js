...
const Skills = () => {
    ...
    return (
        <div className="" id="skills">
            <div className="ml-5">
                <div className="text-4xl pt-[10vh]  tracking-wider">My Skills.</div>
                <div className="mt-5  text-lg ">Frontend
                    <div className="text-sm font-light">Besides html, css and the basics about UX and UI design. <br />
                    </div>
                ...
                <div className=" text-lg ">Backend
                    <div className="text-sm font-light"> Mainly on premise I have a mongoDB mounted on and ubuntu raspberry pi that i use for all my current projects.
                    </div>
                    <div>
                        <div className="bg-blue-600 bg-opacity-40 my-3 mr-3 py-3 px-2 rounded-lg">
                ...
                <div className=" text-lg ">Soft Skills
