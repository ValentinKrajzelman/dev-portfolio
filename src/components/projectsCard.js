...
const ProjectsCard = () => {
    ...
    return (
        <div className="pt-16">
            <div className="flex overflow-auto mb-10 px-20 pt-10 bg-slate-600 bg-opacity-40">
                <div className="flex flex-col place-content-start m-10 ml-5 h-[40vh] min-w-[27vh] max-w-[27vh] bg-[#576B75] bg-opacity-90 rounded-md ">
