        ...
        <div className="pt-16">
            <div className="flex overflow-auto mb-10 px-20 pb-5 bg-slate-600 bg-opacity-40">
                <div className="flex flex-col place-content-start mt-10 ml-5 h-[40vh] min-w-[27vh] max-w-[27vh] bg-[#576B75] bg-opacity-90 rounded-md ">
                    ...
                    <div className=" flex flex-row place-content-around place-items-center text-white border-t-[1px] pt-5">
                        <div className="bg-[#0B5653] flex place-content-around place-items-center h-10 w-20 rounded-md">
                            <a className="transition ease-in-out delay-150 duration-300 bg-[#00C6BD] flex place-content-around place-items-center h-10 w-20 rounded-md border translate-x-[-5px] translate-y-[-5px] hover:translate-x-[0px] hover:translate-y-[0px]" href="">
                ...
                <div className="flex flex-col place-content-start mt-10 ml-5 h-[40vh] min-w-[27vh] max-w-[27vh] bg-[#576B75] bg-opacity-90 rounded-md ">
                    ...
                    <div className="mt-2 mx-2 text-xs font-mono font-light">Este es un proyecto que sirve para registrar bugs que te encuentres en proyectos para que no se te olviden.</div>
                    <div className="mt-12 flex flex-row place-content-around place-items-center text-white border-t-[1px] pt-5">
                        <div className="bg-[#0B5653] flex place-content-around place-items-center h-10 w-20 rounded-md">
                            <a className="transition ease-in-out delay-150 duration-300 bg-[#00C6BD] flex place-content-around place-items-center h-10 w-20 rounded-md border translate-x-[-5px] translate-y-[-5px] hover:translate-x-[0px] hover:translate-y-[0px]" href="">
                                <FiGithub className="mr-1" /> GitHub
                            </a>
